...
for iparam in 1:len
        arms = h5open(string("/home/xuedong/Documents/xuedong/phd/work/code/BestArm.jl/misc/log/difficulty/", reservoir, "(", alphas[iparam], ",", betas[iparam], ")", "_", "dttts_.h5"), "r") do file
                read(file, "dttts")
        end
end
...
groupedbar(nam, mn, group=group, ylabel="Number of arms", title="Number of arms pulled by i times", size=(600, 400))
