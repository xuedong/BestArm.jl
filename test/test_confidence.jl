...
@everywhere policies = [BestArm.d_tracking, BestArm.c_tracking, BestArm.ugape_c, BestArm.best_challenger]
@everywhere namesPolicies = ["D-Tracking", "C-Tracing", "UGapE", "BC"]
